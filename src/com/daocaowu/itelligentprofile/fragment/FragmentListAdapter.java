...
public class FragmentListAdapter extends PagerAdapter {

	private final FragmentManager mFragmentManager;
	private FragmentTransaction mTransaction = null;
	private List<ContentFragment> mFragmentList = new ArrayList<ContentFragment>();
	
	public FragmentListAdapter(FragmentManager fragmentManager, List fragmentList) {
